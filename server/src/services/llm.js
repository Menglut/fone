...
- 채용공고에 [사용자가 선택한 지원 분야] 또는 [선택 분야 세부 정보]가 있으면, 반드시 그 분야 기준으로만 작성하고 다른 모집 분야 조건을 섞지 않는다.
...
- 채용공고에 [사용자가 선택한 지원 분야] 또는 [선택 분야 세부 정보]가 있으면, 반드시 그 분야에 맞는 질문을 우선한다.
...
- 채용공고에 [사용자가 선택한 지원 분야] 또는 [선택 분야 세부 정보]가 있으면, 그 분야와 연결되는 경험 근거인지 우선 평가한다.
...
- 채용공고에 [사용자가 선택한 지원 분야] 또는 [선택 분야 세부 정보]가 있으면, 그 분야와 연결되는 답변 구조를 제안한다.
